                    ...
                    <div class="px-4 py-5 sm:p-6 place-items-center space-y-2">
                        ...
                        <div class="rounded-md flex justify-between divide-x divide-gray-300 bg-white px-3 pt-2.5 w-full md:w-1/2 pb-1 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                            <div>
                                ...
                                <input type="text" name="mailbox" id="mailbox" data-mc="0" data-mb="0" class="block w-full text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-lg/8" placeholder="0000" oninput="this.value=this.value.replace(/\D/g,'')" list="mailbox-suggestions">
                            </div>
                            <div class="flex-auto px-2">
                                <label for="mailbox" class="block text-xs font-medium text-gray-900">Customer</label>
                                <input type="text" name="customer" id="customer" class="block w-full text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-lg/8" placeholder="Customer Name" list="customer-suggestions">
                            </div>
                        </div>
